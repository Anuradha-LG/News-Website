...
<head>
    ...
    <title>Categories - NewsPortal</title>
        ...
        <section class="category-section">
            ...
            <div class="categories">
                <div class="category-card">
                    <h2>Technology</h2>
                    <p>Explore the latest advancements in tech.</p>
                    <a href="#">Read More</a>
                </div>
                <div class="category-card">
                    <h2>Science</h2>
                    <p>Discover breakthroughs and research.</p>
                    <a href="#">Read More</a>
                </div>
                <div class="category-card">
                    <h2>Business</h2>
                ...
                <div class="category-card">
                    <h2>Health</h2>
                    <p>Read tips and news for a healthier lifestyle.</p>
                    <a href="#">Read More</a>
                </div>
            </div>
        </section>
